...
public class IndexingUtilsTest extends ChronoDBUnitTest {
    ...
    public void canGetIndexValuesForObject() {
        ...
        Set<Object> firstNameValues = IndexingUtils
            .getIndexedValuesForObject(Collections.singleton(PersonIndexer.firstName()), johnDoe, "test");
        assertEquals(Sets.newHashSet("John"), firstNameValues);
        Set<Object> lastNameValues = IndexingUtils
            .getIndexedValuesForObject(Collections.singleton(PersonIndexer.lastName()), johnDoe, "test");
    ...
    public void canGetIndexValuesForNullValuedFields() {
        ...
        Set<Object> favoriteColorValues = IndexingUtils
            .getIndexedValuesForObject(Collections.singleton(PersonIndexer.favoriteColor()), johnDoe, "test");
    ...
    public void indexedValuesDoNotContainNullOrEmptyString() {
        ...
        Set<Object> hobbiesValues = IndexingUtils
            .getIndexedValuesForObject(Collections.singleton(PersonIndexer.hobbies()), johnDoe, "test");
    ...
    public void attemptingToGetIndexValuesWithoutIndexerProducesEmptySet() {
        Person johnDoe = createJohnDoe();
        Set<Object> hobbiesValues2 = IndexingUtils.getIndexedValuesForObject(Collections.emptySet(), johnDoe, "test");
