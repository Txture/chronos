...
public interface ChronoIndexDocumentModifications {
	...
	/**
	 * Creates a new, empty {@link ChronoIndexDocumentModifications} instance.
	 *
	 * @return The newly created instance. Never <code>null</code>.
	 */
	public static ChronoIndexDocumentModifications create() {
	 ...
	 */
	public default Map<String, ChronoIndexDocumentModifications> groupByBranch() {
		Map<String, ChronoIndexDocumentModifications> branchToModifications = Maps.newHashMap();
		for (DocumentAddition addition : this.getDocumentCreations()) {
			String branch = addition.getDocumentToAdd().getBranch();
			ChronoIndexDocumentModifications branchModifications = branchToModifications.get(branch);
			if (branchModifications == null) {
				branchModifications = ChronoIndexDocumentModifications.create();
