...
@Tag("performance")
class MatrixPerformanceTest : EnvironmentTest() {
...
//            var result: GetResult<ByteArray>? = null
//            queryTimeNanos += measureNanoTime {
//                result = matrix.get(timestamp, requestKey)
//            }
//            totalLength += result!!.value.let { if (it == null) 0 else it.size }
//        }
