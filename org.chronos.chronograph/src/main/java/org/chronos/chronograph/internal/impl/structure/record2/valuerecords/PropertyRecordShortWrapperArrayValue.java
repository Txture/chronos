...
public class PropertyRecordShortWrapperArrayValue implements PropertyRecordValue<Short[]> {

    private Short[] array;

    protected PropertyRecordShortWrapperArrayValue(){
        // default constructor for kryo
    }

    public PropertyRecordShortWrapperArrayValue(Short[] array){
    ...
    public boolean equals(final Object o) {
        ...
        PropertyRecordShortWrapperArrayValue that = (PropertyRecordShortWrapperArrayValue) o;
