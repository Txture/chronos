...
public class PropertyRecordLongArrayValue implements PropertyRecordValue<long[]> {

    private long[] array;

    protected PropertyRecordLongArrayValue(){
        // default constructor for kryo
    }

    public PropertyRecordLongArrayValue(long[] array){
    ...
    public boolean equals(final Object o) {
        ...
        PropertyRecordLongArrayValue that = (PropertyRecordLongArrayValue) o;
