...
public class PropertyRecordFloatArrayValue implements PropertyRecordValue<float[]> {

    private float[] array;

    protected PropertyRecordFloatArrayValue(){
        // default constructor for kryo
    }

    public PropertyRecordFloatArrayValue(float[] array){
    ...
    public boolean equals(final Object o) {
        ...
        PropertyRecordFloatArrayValue that = (PropertyRecordFloatArrayValue) o;
