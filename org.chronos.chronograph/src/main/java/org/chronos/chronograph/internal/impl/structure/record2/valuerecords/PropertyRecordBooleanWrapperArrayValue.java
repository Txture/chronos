...
public class PropertyRecordBooleanWrapperArrayValue implements PropertyRecordValue<Boolean[]> {
    ...
    public PropertyRecordBooleanWrapperArrayValue(Boolean[] array){
    ...
    public boolean equals(final Object o) {
        ...
        PropertyRecordBooleanWrapperArrayValue that = (PropertyRecordBooleanWrapperArrayValue) o;
