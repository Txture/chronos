...
public class ChronoLogger {
     ...
     *
     * @param logLevel The log level to employ. Must not be <code>null</code>, is a no-op if it is OFF.
     * @param message  The message to log.
     */
     ...
     * </code>
     *
     * @param message The message to log. If <code>null</code>, the empty string will be used instead.
     */
